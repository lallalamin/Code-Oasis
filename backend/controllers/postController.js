...
const getUserPosts = async(req, res) => {
    ...
    try {
        ...
        const posts = await Post.find({postedBy: user._id}).sort({createdAt: -1}); // this mean find post in the following list and sort it by descending order so that we can get the latest post
